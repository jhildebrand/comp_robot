...
void Drive()
{
	if(abs(vexRT[Ch4]) > threshold && (Priority == 1 || Priority == 0))
	{
		Priority = 1;
		X1 = -vexRT[Ch4];
	}
	...
	if(abs(vexRT[Ch1]) > threshold && (Priority == 1 || Priority == 0))
	{
		Priority = 1;
		X2 = vexRT[Ch1];
	}
	...
	if(abs(vexRT[Ch3]) > threshold && (Priority == 1 || Priority == 0))
	{
		Priority = 1;
		Y1 = -vexRT[Ch3];
	}
	...
	/////////////////////////////
	//if(abs(vexRT[Ch4Xmtr2]) > threshold && (Priority == 2 || Priority == 0))
	//{
	//	Priority = 2;
	//	X1 = -vexRT[Ch4Xmtr2];
	//}
	...
	//if(abs(vexRT[Ch1Xmtr2]) > threshold && (Priority == 2 || Priority == 0))
	//{
	//	Priority = 2;
	//	X2 = vexRT[Ch1Xmtr2];
	//}
	...
	//if(abs(vexRT[Ch3Xmtr2]) > threshold && (Priority == 2 || Priority == 0))
	//{
	//	Priority = 2;
	//	Y1 = -vexRT[Ch3Xmtr2];
	//}
